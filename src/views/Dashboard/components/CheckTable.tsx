...
function CheckTable(props: { tableData: any }) {
  ...
  const columns = [
    ...
    columnHelper.accessor("progress", {
      id: "progress",
      header: () => <p className="text-sm font-bold text-gray-600 dark:text-white">Stage</p>,
    ...
    columnHelper.accessor("date", {
      id: "date",
      header: () => <p className="text-sm font-bold text-gray-600 dark:text-white">Waktu pembuatan</p>,
      cell: (info) => <p className="text-sm font-bold text-navy-700 dark:text-white">{info.getValue()}</p>,
    }),
  ...
  return (
    <Card extra={"w-full h-full sm:overflow-auto px-6"}>
      <header className="relative flex items-center justify-between pt-4">
        <div className="text-xl font-bold text-navy-700 dark:text-white">Tiket anda</div>
